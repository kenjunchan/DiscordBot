...
const allCommands = [helpCommands, opggCommands, allOpggCommands, championCommands, memeifyCommands, caesarRodneyCommands, pencaderCommands,
					 pogPlantImageCommands, magic8BallCommands, dogCommands, emptyCommands];
...
function dogCommand(arguments, receivedMessage){
	receivedMessage.channel.send("sending dog image")
...
client.login("NTY2MzUxMjE1MjgyMzU2MjI0.XknYYw.QlOxDIPCFuMI8y-qsHrHovONg_4")